...
3. R2 score for regression
4. Mean Gamma deviance regression loss (MGD) and Mean Poisson deviance regression loss (MPD)
5. Comparision between original stock close price vs predicted close price with chart
6. Predicting next 10 days
7. Plotting last 15 days and next predicted 10 days
8. Plotting whole closing stock price with next 10 days prediction
""")
